...
2. Create GitHub OAuth App and set redirect URI to:
   - `https://<your-autobot-web-host>/api/auth/github/callback`
...
- `APP_BASE_URL`
- `AUTOBOT_WEBHOOK_URL` (point this to your Render service webhook endpoint, e.g. `https://<service>.onrender.com/api/github/webhook`)
- `GITHUB_WEBHOOK_SECRET` (same secret used by Autobot service)
- `AUTOBOT_API_BASE_URL` (Autobot service URL, e.g. `https://your-autobot-service.onrender.com`)
